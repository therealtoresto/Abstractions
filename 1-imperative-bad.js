...
// Bad practies in imperative programming below:
// 1. Single execution sequence, no procedural decomposition
// 2. No appropriate error handling (error ignoring)
// 3. Unnecessary variables and steps (flag, calculations)
// 4. Unclear naming (or extra sort) or no naming (array indexes)
// 5. Long expressions
